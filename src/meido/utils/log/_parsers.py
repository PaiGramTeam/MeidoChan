...
__all__ = ("parse_size", "parse_duration", "parse_frequency", "parse_day", "parse_time", "parse_daytime")
...
def parse_frequency(frequency: str) -> Callable[[datetime.datetime], datetime.datetime] | None:
    return {
...
def parse_time(time: str) -> datetime.time | None:
    time = time.strip()
